...
MENU2(log_menu, "Log", log_menu_commands, FUNCTOR_BIND(&submarine, &Submarine::print_log_menu, bool));

bool Submarine::print_log_menu(void)
{
...
int8_t Submarine::dump_log(uint8_t argc, const Menu::arg *argv)
{
...
int8_t Submarine::erase_logs(uint8_t argc, const Menu::arg *argv)
{
...
int8_t Submarine::select_logs(uint8_t argc, const Menu::arg *argv)
{
	uint16_t	bits;
...
int8_t Submarine::process_logs(uint8_t argc, const Menu::arg *argv)
{
	log_menu.run();
	return 0;
}
...
void Submarine::do_erase_logs(void)
{
...
void Submarine::Log_Write_Performance()
{
...
void Submarine::Log_Write_Steering()
{
...
void Submarine::Log_Write_Startup(uint8_t type)
{
...
void Submarine::Log_Write_Control_Tuning()
{
...
void Submarine::Log_Write_Nav_Tuning()
{
...
void Submarine::Log_Write_Attitude()
{
    Vector3f targets(0,0,0);       // Submarine does not have attitude targets, use place-holder for commonality with Dataflash Log_Write_Attitude message
...
void Submarine::Log_Write_Sonar()
{
...
void Submarine::Log_Write_Current()
{
...
void Submarine::Log_Write_RC(void)
{
    DataFlash.Log_Write_RCIN();
    DataFlash.Log_Write_RCOUT();
}

void Submarine::Log_Write_Baro(void)
{
...
void Submarine::Log_Read(uint16_t log_num, uint16_t start_page, uint16_t end_page)
{
    cliSerial->printf_P(PSTR("\n" FIRMWARE_STRING
                             "\nFree RAM: %u\n"),
	...
	DataFlash.LogReadProcess(log_num, start_page, end_page,
                             FUNCTOR_BIND_MEMBER(&Submarine::print_mode, void, AP_HAL::BetterStream *, uint8_t),
                             cliSerial);
}
#endif // CLI_ENABLED

// start a new log
void Submarine::start_logging()
{
    in_mavlink_delay = true;
...
void Submarine::Log_Write_Nav_Tuning() {}
void Submarine::Log_Write_Performance() {}
int8_t Submarine::process_logs(uint8_t argc, const Menu::arg *argv) { return 0; }
void Submarine::Log_Write_Control_Tuning() {}
//void Submarine::Log_Write_Sonar() {}
void Submarine::Log_Write_Attitude() {}
void Submarine::start_logging() {}
