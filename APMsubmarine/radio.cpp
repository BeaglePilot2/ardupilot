 ...
 */
void Submarine::set_control_channels(void)
{
...
void Submarine::control_failsafe(uint16_t pwm)
{
...
void Submarine::trim_control_surfaces()
{
	read_radio();
