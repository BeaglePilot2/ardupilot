...
bool Submarine::start_command(const AP_Mission::Mission_Command& cmd)
{
...
bool Submarine::verify_command(const AP_Mission::Mission_Command& cmd)
{
    // exit immediately if not in AUTO mode
...
void Submarine::do_nav_wp(const AP_Mission::Mission_Command& cmd)
{
	set_next_WP(cmd.content.location);
}

bool Submarine::verify_nav_wp(const AP_Mission::Mission_Command& cmd)
{
...
void Submarine::do_wait_delay(const AP_Mission::Mission_Command& cmd)
{
	condition_start = millis();
	condition_value  = cmd.content.delay.seconds * 1000;    // convert seconds to milliseconds
}

void Submarine::do_within_distance(const AP_Mission::Mission_Command& cmd)
{
	condition_value  = cmd.content.distance.meters;
}

bool Submarine::verify_wait_delay()
{
...
bool Submarine::verify_within_distance()
{
...
void Submarine::do_change_speed(const AP_Mission::Mission_Command& cmd)
{
...
void Submarine::do_set_home(const AP_Mission::Mission_Command& cmd)
{
...
void Submarine::do_digicam_configure(const AP_Mission::Mission_Command& cmd)
{
#if CAMERA == ENABLED
...
void Submarine::do_digicam_control(const AP_Mission::Mission_Command& cmd)
{
#if CAMERA == ENABLED
...
void Submarine::do_take_picture()
{
#if CAMERA == ENABLED
