...
#define THISFIRMWARE "APMsubmarine v0.1"
...
// Inertial Navigation EKF
    ...
    // The Submarine's current location
    ...
    // Waypoint distances
    // Distance between Submarine and next waypoint.  Meters
    float wp_distance;
...
#define MENU_FUNC(func) FUNCTOR_BIND(&submarine, &Submarine::func, int8_t, uint8_t, const Menu::arg *)
