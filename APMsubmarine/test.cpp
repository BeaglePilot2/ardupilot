...
int8_t Submarine::test_mode(uint8_t argc, const Menu::arg *argv)
{
...
void Submarine::print_hit_enter()
{
	cliSerial->printf_P(PSTR("Hit Enter to exit.\n\n"));
}

int8_t Submarine::test_radio_pwm(uint8_t argc, const Menu::arg *argv)
{
	print_hit_enter();
	delay(1000);
...
int8_t Submarine::test_passthru(uint8_t argc, const Menu::arg *argv)
{
	print_hit_enter();
	delay(1000);
...
int8_t Submarine::test_radio(uint8_t argc, const Menu::arg *argv)
{
	print_hit_enter();
	delay(1000);
...
int8_t Submarine::test_failsafe(uint8_t argc, const Menu::arg *argv)
{
	uint8_t fail_test;
	print_hit_enter();
	for(int i = 0; i < 50; i++){
...
int8_t Submarine::test_relay(uint8_t argc, const Menu::arg *argv)
{
	print_hit_enter();
	delay(1000);
...
int8_t Submarine::test_wp(uint8_t argc, const Menu::arg *argv)
{
	delay(1000);
...
void Submarine::test_wp_print(const AP_Mission::Mission_Command& cmd)
{
...
int8_t Submarine::test_modeswitch(uint8_t argc, const Menu::arg *argv)
{
	print_hit_enter();
	delay(1000);
 ...
 */
int8_t Submarine::test_logging(uint8_t argc, const Menu::arg *argv)
{
...
int8_t Submarine::test_gps(uint8_t argc, const Menu::arg *argv)
{
    print_hit_enter();
    delay(1000);
...
int8_t Submarine::test_ins(uint8_t argc, const Menu::arg *argv)
{
...
void Submarine::print_enabled(bool b)
{
       if(b)
...
int8_t Submarine::test_mag(uint8_t argc, const Menu::arg *argv)
{
	if (!g.compass_enabled) {
...
int8_t Submarine::test_sonar(uint8_t argc, const Menu::arg *argv)
{
    init_sonar();
    delay(20);
    sonar.update();
 ...
 *  run a debug shell
 */
int8_t Submarine::test_shell(uint8_t argc, const Menu::arg *argv)
{
