...
void Submarine::init_barometer(void)
{
...
void Submarine::init_sonar(void)
{
    sonar.init();
}
...
void Submarine::read_battery(void)
{
    battery.read();
}
...
void Submarine::read_receiver_rssi(void)
{
...
// read the sonars
void Submarine::read_sonars(void)
{
    sonar.update();
