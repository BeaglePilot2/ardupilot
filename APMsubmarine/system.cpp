...
int8_t Submarine::main_menu_help(uint8_t argc, const Menu::arg *argv)
{
...
int8_t Submarine::reboot_board(uint8_t argc, const Menu::arg *argv)
{
...
void Submarine::run_cli(AP_HAL::UARTDriver *port)
{
...
{
    submarine.mavlink_delay_cb();
}

static void failsafe_check_static()
{
    submarine.failsafe_check();
}
...
//********************************************************************************
void Submarine::startup_ground(void)
{
 ...
 */
void Submarine::set_reverse(bool reverse)
{
...
void Submarine::set_mode(enum mode mode)
{
 ...
 */
bool Submarine::mavlink_set_mode(uint8_t mode)
{
    switch (mode) {
    case MANUAL:
    case HOLD:
 ...
 */
void Submarine::failsafe_trigger(uint8_t failsafe_type, bool on)
{
...
void Submarine::startup_INS_ground(void)
{
...
void Submarine::update_notify()
{
    notify.update();
}

void Submarine::resetPerfData(void) {
	mainLoop_count 			= 0;
	G_Dt_max 				= 0;
...
void Submarine::check_usb_mux(void)
{
...
void Submarine::print_mode(AP_HAL::BetterStream *port, uint8_t mode)
{
    switch (mode) {
    case MANUAL:
 ...
 */
uint8_t Submarine::check_digital_pin(uint8_t pin)
{
 ...
 */
bool Submarine::should_log(uint32_t mask)
{
 ...
 */
#if FRSKY_TELEM_ENABLED == ENABLED
void Submarine::frsky_telemetry_send(void)
{
